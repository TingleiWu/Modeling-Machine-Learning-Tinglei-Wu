...
* Based on the second graph above, we can see that the variance has increased from the original graph, and the bias has decreased. This is the bias-variance trad-off after adding the squared terms for x1 and x2. 
